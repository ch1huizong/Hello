...
public class HookerDexMakerNew implements HookMaker {
    ...
    private void setup(Class mHookClass) {
        XHelpers.setStaticObjectField(mHookClass, FIELD_NAME_METHOD, mMember);
        XHelpers.setStaticObjectField(mHookClass, FIELD_NAME_BACKUP_METHOD, mBackupMethod);
        XHelpers.setStaticObjectField(mHookClass, FIELD_NAME_HOOK_INFO, mHookInfo);
    }
